"""
referral_table — stores the raw form data submitted through the "Refer a
friend" UI: gender, experience, salary, fit reason, and who submitted the
referral. Separate from the candidates table insert (handled by
referral_processing.py), since these fields never come from resume
extraction.
"""
